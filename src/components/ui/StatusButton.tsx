...
export function StatusButton({
  ...
  const colorClasses = {
    green: {
      active: "border-green-300 dark:border-green-600 bg-green-50 dark:bg-green-900/20",
      inactive: "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 bg-white dark:bg-gray-800",
      iconActive: "bg-green-500 text-white",
      iconInactive: "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400",
      textActive: "text-green-700 dark:text-green-300",
      textInactive: "text-gray-900 dark:text-white"
    },
    yellow: {
      active: "border-yellow-300 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-900/20",
      inactive: "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 bg-white dark:bg-gray-800",
    ...
    gray: {
      active: "border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900/20",
      inactive: "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 bg-white dark:bg-gray-800",
