...
import { Clock, Zap, CheckCircle, Presentation, Download, FileText } from "lucide-react";
          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div
                  className={`inline-flex items-center space-x-1 px-2 py-1 rounded-md text-sm font-medium ${currentStatus === "completed"
                ...
                {statusButtons.map(({ status, label, color, icon }) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center ${isActive
                              ? color === "green"
